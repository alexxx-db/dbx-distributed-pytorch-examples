...
train_dataset = CIFARDataset(cifar_dataset['train'], transform=transform)
test_dataset = CIFARDataset(cifar_dataset['test'], transform=transform)
...
dist.run(train_func, epochs=1, batch_size = 128, train_dataset = train_dataset, test_dataset = test_dataset, mlflow_parent_run=parent_run)
